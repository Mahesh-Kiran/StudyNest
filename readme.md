...
| 📂 Subject-Wise File Uploads | PDFs go to their subjects, not random folders |
...
- Adds subjects  
- Uploads PDFs  
- Deletes outdated files when syllabus suddenly changes 🙃  
- Backend automatically generates subject pages  

### 🎓 Student
- Opens subjects  
- Downloads study material  
- Pretends they will actually read it 😅  
